  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      ...
      <div class="pull-left info">
        <p><?php echo e(ucfirst(Auth::user()->name)); ?><a style="font-weight: lighter;"> (<?php echo e(Auth::user()->roles()->pluck('name')->first()); ?>)</a></p>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li>
        <a href="<?php echo e(route('tau.index')); ?>">
      ...
      <li>
        <a href="<?php echo e(route('hanhtrinh.index')); ?>">
